...
<body>
 ...
 <form action="<?= base_url('productboard/save') ?>" method="post" enctype="multipart/form-data" class="search-form" id="Form">
...
<?php if (!empty($product) && is_array($product)): ?>
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?= base_url('productboard/delete/'.$p['productID']) ?>" onclick="return confirm('Yakin hapus?')">Delete</a>
        </td>
    </tr>
    <?php endforeach; ?>
<?php else: ?>
    <tr><td colspan="9" style="text-align:center">Belum ada produk</td></tr>
<?php endif; ?>
</tbody> 
