        ...
        <div class="content">
            ...
            <div class="page-header">
                <div class="header-left">
                    ...
                    <p class="subtitle">Lihat data Pengguna Toko Kosmetik</p>
                </div>
            </div>
            ...
            <div class="form-card">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead>
                            <tr style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                                <th style="padding: 12px; text-align: left; font-weight: 600; color: #334155;">Nama
                                    Pengguna</th>
                                <th style="padding: 12px; text-align: left; font-weight: 600; color: #334155;">Email
                                </th>
                                <th style="padding: 12px; text-align: left; font-weight: 600; color: #334155;">Nomor HP
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #e2e8f0;">
                                <td style="padding: 12px; color: #1e293b; font-weight: 500;"><?= esc($p['UserName']) ?>
                                </td>
                                <td style="padding: 12px; color: #475569;"><?= esc($p['Email']) ?></td>
                                <td style="padding: 12px; color: #475569;"><?= esc($p['noHP']) ?></td>
                                <td
                                    style="padding: 12px; color: <?= ($p['Alamat'] === 'Belum mengisi alamat') ? '#94a3b8' : '#475569' ?>;
                                       font-style: <?= ($p['Alamat'] === 'Belum mengisi alamat') ? 'italic' : 'normal' ?>;">
                                    <?= esc($p['Alamat']) ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    ...
                    <a href="<?= base_url('admin/users/index/' . $i) ?>" style="margin: 0 5px; padding: 8px 12px;
                              background: <?= ($i == $page) ? '#0d6efd' : '#e2e8f0' ?>;
