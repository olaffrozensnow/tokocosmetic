    ...
    <div class="content">
        <div class="page-header">
            <div class="header-left">
                ...
                <p class="subtitle">Update informasi produk: <strong><?= esc($product['productName']) ?></strong></p>
            </div>
        ...
        <div class="form-card">
            <form action="<?= base_url('admin/product/update/' . $product['productID']) ?>" method="post"
                    ...
                    <div class="upload-section">
                        ...
                        <div class="upload-area" onclick="document.getElementById('GambarProduct').click()">
                            ...
                            <div id="imagePreview" class="image-preview" style="display: block;">
                                <img id="previewImg" src="data:image/jpeg;base64,<?= $product['GambarProduct'] ?>"
                                    alt="Current Image">
                        ...
                        <div class="fields-section">
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-input" value="<?= esc($product['productID']) ?>"
                                        disabled>
                                    <span class="input-hint">
                                        <i class="fas fa-lock"></i> ID tidak dapat diubah
                                    </span>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select-wrapper">
                                        <select
                                            class="form-input <?= $validation->hasError('categoryID') ? 'error' : '' ?>"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-input <?= $validation->hasError('merk') ? 'error' : '' ?>"
                                        name="merk" id="merk" value="<?= old('merk', $product['merk']) ?>"
                                        placeholder="Masukkan merk" maxlength="20" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        class="form-input <?= $validation->hasError('Stok') ? 'error' : '' ?>"
                                        name="Stok" id="Stok" value="<?= old('Stok', $product['Stok']) ?>"
                                        placeholder="0" min="0" max="99" required>
